      ...
      body: SafeArea(
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            ...
            final tasks =
                (data?['linked_tasks'] as List?)?.cast<Map<String, dynamic>>() ??
                    [];
            final reflections =
                (data?['linked_reflections'] as List?)?.cast<Map<String, dynamic>>() ??
                    [];
                ...
                Expanded(
                  child: RefreshIndicator(
                    ...
                    child: ListView(
                      ...
                      children: [
                        if (snapshot.connectionState == ConnectionState.waiting && goal == null)
                          const Padding(
                          ...
                          if (tasks.isEmpty)
                            const _EmptyCard(text: 'No tasks are linked to this goal yet.')
                          else
                            ...tasks.map(
                          ...
                          if (reflections.isEmpty)
                            const _EmptyCard(text: 'No reflections are linked to this goal yet.')
                          else
                            ...reflections.map(
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            final data = snapshot.data;
            final reflection = (data?['reflection'] as Map?)?.cast<String, dynamic>();
            final goal = (data?['linked_goal'] as Map?)?.cast<String, dynamic>();
                ...
                Expanded(
                  child: RefreshIndicator(
                    ...
                    child: ListView(
                      padding: const EdgeInsets.fromLTRB(20, 0, 20, 24),
                      children: [
                        if (snapshot.connectionState == ConnectionState.waiting && reflection == null)
                          const Padding(
                            padding: EdgeInsets.symmetric(vertical: 80),
                            child: Center(child: CircularProgressIndicator()),
                          )
                              ...
                              children: [
                                Wrap(
                                  ...
                                  children: [
                                    ...
                                    if (goal != null) _Chip(label: goal['title']?.toString() ?? 'Linked goal'),
                                  ],
                                ),
                                const SizedBox(height: 14),
                                ...
                                if ((reflection?['wins']?.toString() ?? '').isEmpty &&
                                    (reflection?['challenges']?.toString() ?? '').isEmpty &&
                                    (reflection?['lessons']?.toString() ?? '').isEmpty)
                                  const Text(
...
class _GoalLinkOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Material(
        color: selected ? const Color(0xFFF1E9F5) : Colors.white.withValues(alpha: 0.7),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(icon, color: const Color(0xFF6F5081), size: 20),
                ),
                ...
                if (selected)
                  const Icon(Icons.check_rounded, color: Color(0xFF6F5081)),
              ],
            ),
          ),
        ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        reflection['type']?.toString().toUpperCase() ?? 'REFLECTION',
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w800,
                          color: Color(0xFF1B1C1A),
                ...
                const Icon(Icons.arrow_forward_rounded, size: 18, color: Color(0xFF1B1C1A)),
              ],
            ),
          ),
        ),
