            ...
            children: [
              _GlassPanel(
                child: Column(
                  ...
                  children: [
                    const Text('Source privacy', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: _purple)),
                    ...
                    Align(
                      ...
                      child: FilledButton(
                        ...
                        child: Text(_deleteBusy ? 'Deleting...' : 'Delete imported data'),
                      ),
                    ),
                  ],
                ),
              ...
              _GlassPanel(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(accounts.isEmpty ? 'No accounts connected.' : accounts.map((a) => a['provider'].toString()).join('\n')),
                  ],
                ),
              ),
            ],
