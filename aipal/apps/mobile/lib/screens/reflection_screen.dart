...
class _ReflectionScreenState extends State<ReflectionScreen> {
  ...
  Future<List<dynamic>> _load() => context.read<AppState>().api.listReflections();
  ...
  Future<void> _editReflection([Map<String, dynamic>? reflection, String? forcedType]) async {
    final api = context.read<AppState>().api;
    final winsController = TextEditingController(text: reflection?['wins']?.toString() ?? '');
    final challengesController = TextEditingController(text: reflection?['challenges']?.toString() ?? '');
    final lessonsController = TextEditingController(text: reflection?['lessons']?.toString() ?? '');
    final moodController = TextEditingController(text: reflection?['mood']?.toString() ?? '');
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Reflections',
                          style: TextStyle(fontFamily: 'Manrope', fontSize: 28, fontWeight: FontWeight.w800, color: Color(0xFF1B1C1A)),
                        ),
                        SizedBox(height: 2),
                        Text(
                  ...
                  TextButton(onPressed: () => _editReflection(null, 'daily'), child: const Text('Daily')),
                  TextButton(onPressed: () => _editReflection(null, 'weekly'), child: const Text('Weekly')),
                ],
              ),
            ),
            Expanded(
                        ...
                        if (reflections.isEmpty)
                          ...
                          ...reflections.map(
                            (reflection) => _ReflectionCard(
                              ...
                              onEdit: () => _editReflection(reflection.cast<String, dynamic>()),
                              onDelete: () => _deleteReflection(reflection['id'].toString()),
                            ),
                          ),
                      ],
                    );
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        ...
                        style: const TextStyle(fontFamily: 'Manrope', fontSize: 16, fontWeight: FontWeight.w800, color: Color(0xFF1B1C1A)),
                      ),
                    ),
                ...
                if ((reflection['challenges']?.toString() ?? '').isNotEmpty)
                  _Block(label: 'Challenges', value: reflection['challenges'].toString()),
                if ((reflection['lessons']?.toString() ?? '').isNotEmpty)
                  _Block(label: 'Lessons', value: reflection['lessons'].toString()),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFFFAF9F5), borderRadius: BorderRadius.circular(30)),
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _Field(controller: challengesController, label: 'Challenges', maxLines: 3),
            const SizedBox(height: 12),
            _Field(controller: lessonsController, label: 'Lessons', maxLines: 3),
            const SizedBox(height: 12),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: Color(0xFF6F5081))),
          const SizedBox(height: 3),
          Text(value, style: const TextStyle(fontSize: 13.5, height: 1.5, color: Color(0xFF4B444D))),
        ],
      ),
    );
  }
...
class _Chip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFFF4F1EB), borderRadius: BorderRadius.circular(999)),
      child: Text(label, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: Color(0xFF1B1C1A))),
    );
  }
}
...
class _HeaderButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: IconButton(icon: Icon(icon, color: const Color(0xFF1B1C1A)), onPressed: onTap),
    );
  }
}
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Text('No reflections yet. Daily or weekly reviews will appear here.', style: TextStyle(fontSize: 14, height: 1.5, color: Color(0xFF4B444D))),
    );
  }
}
...
class _SheetHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 48,
      height: 5,
      decoration: BoxDecoration(color: const Color(0xFFCEC3CE), borderRadius: BorderRadius.circular(999)),
    );
  }
}
