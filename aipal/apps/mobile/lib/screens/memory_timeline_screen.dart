            ...
            Wrap(
              ...
              children: milestones.take(6).map((item) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF326667).withValues(alpha: 0.10),
                    borderRadius: BorderRadius.circular(999),
                  ),
                  child: Text(
...
class _TimelineItemCard extends StatelessWidget {
  ...
  Color _sentimentColor(String? sentiment) {
    return switch (sentiment) {
      'positive' => const Color(0xFF326667),
                ...
                children: [
                  ...
                  if ((item['follow_up_prompt']?.toString() ?? '')
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFF326667).withValues(alpha: 0.08),
  ...
  Color _typeColor(String type) {
    return switch (type) {
      'win' => const Color(0xFF326667),
      'important_event' => const Color(0xFF6F5081),
