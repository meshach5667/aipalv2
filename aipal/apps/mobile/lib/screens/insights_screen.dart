...
const Color _timelineDotColor = Color(0xFF326667);
...
class _HeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = switch (accent) {
      'happy' => const Color(0xFF326667),
      'excited' => const Color(0xFF6F5081),
      'sad' || 'anxious' || 'frustrated' => const Color(0xFFBA1A1A),
      _ => const Color(0xFF6F5081),
    };
      ...
      children: followups.take(3).map((item) {
        return Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFF6F5081).withValues(alpha: 0.08),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(icon, size: 20, color: const Color(0xFF6F5081)),
              const SizedBox(width: 10),
              Text(
                title,
                style: const TextStyle(
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 38,
            decoration: BoxDecoration(
              color: const Color(0xFFF4D9FF).withValues(alpha: 0.75),
