...
class _CoachScreenState extends State<CoachScreen> {
  ...
  Future<void> _analyze() async {
    ...
    final options = _optionsController.text
        ...
        .toList();
    final api = context.read<AppState>().api;
    final result = await api.coachDecision(question, options: options.isEmpty ? null : options);
    if (!mounted) return;
    setState(() {
      _result = result;
      _future = _load();
      ...
      body: RefreshIndicator(
        ...
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            ...
            final frameworks = (data?['frameworks'] as List<dynamic>? ?? const []);
                        ...
                        children: frameworks
                            ...
                            .map(
                              (framework) => _FrameworkChip(
                                ...
                                description: framework['description']?.toString() ?? '',
                              ),
                            )
                            .toList(),
                      ),
