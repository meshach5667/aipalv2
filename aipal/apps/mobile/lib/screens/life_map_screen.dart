    ...
    return const Stack(
      children: [
        Positioned(
          top: -120,
          right: -80,
          child: _BlurBlob(color: Color(0x336F5081), size: 260),
        ),
        Positioned(
          bottom: -90,
          left: -60,
...
class _SparseNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _GlassCard(
      ...
      child: Row(
        children: [
          Icon(Icons.info_outline_rounded, color: Color(0xFF326667)),
          SizedBox(width: 12),
          Expanded(
            child: Text(
        ...
        children: [
          Row(
            children: [
              ...
              const Icon(Icons.chevron_right_rounded, color: Color(0xFF6F5081)),
            ],
          ),
          const SizedBox(height: 18),
          ClipRRect(
...
class _IconBubble extends StatelessWidget {
  const _IconBubble({required this.icon, this.color = const Color(0xFF326667)});
...
class _LoadingLifeMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Center(
      child: CircularProgressIndicator(color: Color(0xFF326667)),
    );
  }
}
