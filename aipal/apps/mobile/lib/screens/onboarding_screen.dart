  ...
  Future<void> _finish() async {
    ...
    try {
      ...
      await state.updateProfile({
        'wake_name':
            _wakeName.text.trim().isEmpty ? 'friend' : _wakeName.text.trim(),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF6F5081).withValues(alpha: 0.24),
            blurRadius: 24,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        _bar(48, const Color(0xFF6F5081)),
        const SizedBox(width: 8),
        _bar(32, const Color(0xFFE3E2DF)),
      ],
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(999),
        border: Border.all(
          color: const Color(0xFF6F5081).withValues(alpha: 0.1),
        ),
      ),
      child: const Row(
        mainAxisSize: MainAxisSize.min,
