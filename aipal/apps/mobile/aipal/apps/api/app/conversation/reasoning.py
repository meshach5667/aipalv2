...
class ReasoningDecision(BaseModel):
    ...
    response_plan: list[str] = Field(default_factory=list, max_length=6)
    ...
    @field_validator("required_context", "required_tools", "assumptions", "response_plan", "missing_information", "planning_notes")
    @classmethod
