...
def user_to_profile(user: User) -> ProfileResponse:
    return ProfileResponse(
        ...
        knowledge_gap_data_consent=user.knowledge_gap_data_consent,
    )
...
async def update_profile(
    ...
    if body.knowledge_gap_data_consent is not None:
        user.knowledge_gap_data_consent = body.knowledge_gap_data_consent
    await db.commit()
