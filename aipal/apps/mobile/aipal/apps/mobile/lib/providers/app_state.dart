...
class AppState extends ChangeNotifier {
  ...
  String get wakeName => _wakeName.isNotEmpty ? _wakeName : 'Friend';

  bool get hasUnreadNotifications => notifications.any(
        (notification) => (notification['read'] as bool? ?? false) != true,
      );
