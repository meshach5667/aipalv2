...
The mobile app defaults to `http://10.0.2.2:8102/api/v2` on the Android
emulator and `http://127.0.0.1:8102/api/v2` elsewhere. Override it with
`--dart-define=API_BASE_URL=...` for a physical device or remote API.
